...
/* ./.libs/lt-simple.c - temporary wrapper executable for .libs/simple
...
const char * TARGET_PROGRAM_NAME = "simple"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# simple - temporary wrapper script for .libs/simple\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The simple program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /usr/lib/libao.la /usr/lib/libvorbisfile.la /usr/lib/libvorbis.la /usr/lib/libogg.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"simple:simple:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"simple:simple:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"simple:simple:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
